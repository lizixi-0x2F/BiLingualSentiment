...
OUTPUT_DIR="outputs/regularized_model_${TIMESTAMP}"

# 创建输出目录
mkdir -p "$OUTPUT_DIR"

# 输出配置信息
echo "启动情感分析模型训练 (增强正则化版本)..."
echo "========================================"
echo "设备: $DEVICE"
...
echo "增强正则化: Dropout=0.3, Weight Decay=0.02"
echo "========================================"

# 在screen会话中运行训练
echo "在screen会话中启动训练..."
SCREEN_NAME="regularized_model_${TIMESTAMP}"
